...
<?php
					...
					if($page==view) {
					  $sql = "SELECT * FROM elearning where estatus='accept' ";
					 ...
					 $sql = "SELECT * FROM elearning where estatus='accept' order by eid DESC limit $start,$limit";
...
<?php
	...
	$next = $start+5;
	if($start!=0){
	echo "<a href=\"index.php?page=view&start= ".$prev."\" class=\"style3\"><img src=\"icon/back1.gif\"></a>";
	}
	echo "<img src=\"icon/blank.jpg\" width='50'>";
	//echo $start.sss.$num;
	if($start < $num-5){
	echo "<a href=\"index.php?page=view&start= ".$next."\" class=\"style3\"><img src=\"icon/next1.gif\"></a>";
	}
}	
?>
