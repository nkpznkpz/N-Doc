  ...
  <table width="100%" border="0">
    <tr>
      <td width="22%" valign="top"><table width="100%" border="0" class="form">
        ...
        <tr>
          <td bgcolor="#B3D1FF"><div align="center">ลบหมวดหมู่</div></td>
        </tr>
      </table></td>
      <td width="78%">
      <form id="fadd" name="fadd" method="post" action="deletegroup.php">
        <table width="500" border="1" cellpadding="0" cellspacing="0" bordercolor="#0066FF">
          ...
          <tr>
            <td><table width="100%" border="0">
                <tr>
                  <td width="49%"><div align="right">กรุณากรอกเลือกหมวดหมู่</div></td>
...
?>
 ...
 ?>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" name="button4" id="button5" value="ลบหมวดหมู่" />
                      <input type="reset" name="button4" id="button6" value="ยกเลิก" /></td>
                </tr>
            </table></td>
          </tr>
        </table>
